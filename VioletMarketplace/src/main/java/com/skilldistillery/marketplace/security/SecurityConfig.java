...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .antMatchers(HttpMethod.POST, "/api/tokens").permitAll()     // Allow public access for GET// will hit the OPTIONS on the route
        .antMatchers(HttpMethod.GET, "/api/tokens").permitAll()     // Allow public access for GET// will hit the OPTIONS on the route
